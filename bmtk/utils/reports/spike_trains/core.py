        ...
        if sort_order == SortOrder.by_id:
            ...
            for pop_name in populations:
                ...
                if self._population_sorting_map[pop_name] == SortOrder.by_time:
                    ...
                    # print(ts_indices[0:10])
                    #print ts_indices
                    #for i in range(0, 15):
                    #    print(ts_indices[i], ts_ds[ts_indices[i]])
                    # exit()
            ...
            while index_ranges:
                ...
                if ds_index >= selected_r[2]:
                    ...
                    #print '>>', ts_index, self._population_map[pop_name][DATASET_timestamps][selected_r[3][ds_index]]
                    next_ts = self._population_map[pop_name][DATASET_timestamps][selected_r[3][ds_index]]
                    # print '>>', ts_index, pop_grp[DATASET_timestamps][selected_r[3][ds_index]]
