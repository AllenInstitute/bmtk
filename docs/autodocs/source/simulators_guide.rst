...
.. grid:: 1 1 4 5
    ...
    .. grid-item-card:: Current Clamp (IClamp) Stimulus
        ...
        * Add excitatory or inhibitory current clamping to one or more select cells.
        * Create multiple stimulus square-wave blocks.
    ...
    .. grid-item-card:: Voltage Clamping
        ...
        * Inject a voltage clamp into one or more select cells.
        * Input in the form of a square-block, or more complex patterns using files or functions.
        * How to select location to insert clamp (BioNet).
    ...
    .. grid-item-card:: Allen Cell-Types Database intracellular Sweeps
        ...
        * Use Allen Cell-Types intracullar experimental stimuli (sweep) for simulation stimulus.
    ...
    .. grid-item-card:: Extracellular Stimulation with BioNet
        ...
        * Produce extracullar field with an extracullar electrode or mesh.
        * How to set channel location and extracellular resistance.
        * Use a constant field, sin wave, or your own custom voltage function.
        * How to use COMSOL physical simulator to simulate with complex field dynamics.
    ...
    .. grid-item-card:: Generating Spikes from Movies in FilterNet
        ...
        * How to generate custom movies for FilterNet stimulus.
