...
point_models = [
    {
        'pop_name': 'LIFe4Scnn1a', 'ei': 'e',
        'dynamics_params': 'IntFire1_exc_1.json'
    },
    {
        'pop_name': 'LIFi4Pvalb', 'ei': 'i',
        'dynamics_params': 'IntFire1_inh_1.json'
    }
]

# Build a network of 300 biophysical cells to simulate
internal = NetworkBuilder("v1")
